...
> `คำเตือน` สำหรับใครที่เกมอัปเดตเป็น 0.1.5.0 แล้วแนะนำให้ทำการถอนการติดตั้งม็อดออกก่อนนะครับ เพื่อไม่ให้กระทบต่อกลศาสตร์ของตัวเกม ตัวม็อดที่รองรับเวอร์ชันดังกล่าวจะตามมาเร็ว ๆ นี้
{: .prompt-danger }
